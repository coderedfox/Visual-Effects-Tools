...
#MOTools addition
def setup_Cam_MayatoNuke_ui(themenu,thesubmenus):
    if nuke.GUI:
        toolbar = nuke.menu('Nodes')   
        menu = toolbar.addMenu(themenu, '',index=-1)  
        menu.addCommand(thesubmenus, 'Cam_MayatoNuke_EXR.createCam_Cam_MayatoNuke( )', icon='')    
